...
//	//构造方法
	public Individual(Individual individual) {
	  ...
	  //第index上的位置值为val
	  public void setVariables(int index, double val) {
		  this.variables[index] = val;
	  }
	  //
	  public void setVariables2(int index, double val) {
	  ...
	  public double getVariables2(int index) {
	  ...
	  public double [] getAllVariables2() {
		  return variables2;
	  }
	  ...
	  double[] variables = new double[Tool.TaskNum] ;//存变量  存vm的序号
	  double[] variables2 = new double[Tool.TaskNum];//存第二个  存order
